(function() {
  ...
  function testDirectVisit() {
        ...
        // Referrer is empty, therefore = DirectVisit
        ...
        // Referrer is previously visited page, therefore = Internal Visit
        //VF_Track.log().track('wikipedia.org', 'https://wikipedia.org', 'https://wikipedia.org/page');
